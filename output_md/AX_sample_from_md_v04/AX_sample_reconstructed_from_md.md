...
![Image](output_md/AX_sample_from_md_v04/pictures/KPI_운영_Issue_image_0.png)
...
![Image](output_md/AX_sample_from_md_v04/pictures/①_과제_재분류_방안_image_0.png)  

### 1. 상품 분류  
가맹점 상품을 **브랜드 연계성** 및 **식품 목표 수준**에 따라 3개 유형으로 분류  
...
- **브랜드 연계성**  
  - SCM와 협의된 연간·장기 판매계획과 연계된 식품 상품인가?  

- **식품 도입 수준**  
  - 식품 중심으로 프로세스가 리뉴얼 되는가?  

- **재무·매출효과 수준**  
  - 매출 또는 비용으로 환산했을 때 매출효과가 큰가?  

- **주력 경쟁력 확보 여부**  
  - 중장기적으로 회사의 ‘주력 경쟁력’ 확보를 위한 상품인가?  

- **본사 관리 방안**  
  - 본사 모니터링(진척도·품질지표 달성 여부·이슈 트래킹)  
  - 프레시푸드그룹 중점 상품 대상 밀착 지원·관리(센터 조리기술 지원)  

---

## 상품 유형별 예시  

| 유형 | 카테고리 | 브랜드 연계성 | 식품 도입 수준 | 재무·매출효과 | 주력 경쟁력 확보 | 본사 관리 방안 | 비고 |
|------|----------|----------------|----------------|--------------|----------------|----------------|------|
| 프리미엄 | 신선식품 | YES | YES / 사업 영업전략과 align 되어 있으며, 식품 업무 혁신을 수반하는 상품 (+ 高 매출효과) |  | YES / 매장 ‘주력 경쟁력’ 확보 상품 (품질/조리기술 관점) | 본사 모니터링 / 진척도·품질지표 달성 여부 모니터링·이슈 tracking <br>프레시푸드그룹 중점 상품 대상 밀착 지원·관리·Center 조리기술 지원 | 사업의 본질, 메뉴구성 변화 |
| 일반 | 가공식품 | YES | NO / 브랜드 연계성이 높으나, 단위 업무를 개선하는 수준의 상품 (or 프레시푸드그룹 차원의 전국확대 가능한 상품) |  | YES / 사업 목표 달성을 위해 반드시 수행해야 하는 상품 (위생규정, 식품안전법 등) | 본사 모니터링 / 진척도·품질지표 달성 여부 모니터링·이슈 tracking |  |
| PB상품 | 즉석식품 | NO | n/a / 재무적 매출효과 산정이 불가능하거나, 조리설비성 상품도 즉석식품 유형에 포함 (원재료 확보, 특정 조리기술 공동 상품개발 등) |  |  | 매장 자체 관리 |  |

*※ 표에 빈 셀은 원본 그대로 유지했으며, 셀 내 줄바꿈은 “ / ” 로 대체했습니다.*
...
### 1) 브랜드 연계성 기준  
- 본사에 보고된 연간·장기 판매계획 List 중 SCM‑매장 간 ‘주력 영업전략 Theme’을 최대 2개 선정하여 브랜드 연계성 구분에 활용  
...
- 품질·조리기술력 확보 관련 상품을 우선시하며, 신선식품 유형으로 협의되지 않는 상품은 가공식품 유형으로 분류  
...
- **대표이사 격월 보고 상품**  
- 신선식품 중 ‘중점 관리 상품’ + 신선식품·가공식품 유형 상품 중 진행 상황에서 경고 표시인 상품 → 신선식품 내 중점 관리 상품 기준 논의 및 매장 협의 필요  
- 본사에서 양식 제공 필요  

### 5) 기타  
- **전국확대 가능한 상품**(대다수 PB상품) → 본사 차원에서 관리·전파 방안 논의  
- **생산업 특화 전국확대 상품** → 정기 협의체에서 benchmarking  
- **백오피스 전국확대 상품** → 본사에서 도출·진행 (HR, 재무 등)  
- **조리설비 성격 상품** → 기존 기타 분류에서 즉석식품으로 전환, 매장 자체 관리 제안  
- **산학상품·식품 Day 상품** → 각 매장 식품 영업전략 상품에 포함하여 관리 (2026년 신규 상품부터 적용)  
...
- 사업 성과와 연결되는 이러한 상품은 본사에서도 진행 상황을 모니터링하며 실행력 강화에 기여  
...
|   |   |   |   |   | 상품기획 | 시식테스트 | 상품개발 | 매장운영 |   |   |   |   |   |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
|   |   | 정의 | 향후 식품 영업전략을 수립하거나, 식품상품 / 서비스 / 물류시설 등의 상품개발 요건을 구체화하는 단계 | 식품상품 / 서비스 / 물류시설 등 본격적 상품개발에 앞서 한정된 Scope 내 구현하여 본상품개발/매장 적용 가능성 테스트 | 재무적 기대효과와 예상 비용을 도출한 뒤, 이를 달성하기 위해 상정한 기능/품질을 실제로 구현 | 상품개발한 식품상품 / 서비스를 매장운영해, 재무적 기대효과 구현 |   |   |   |   |   |
|   |   | Goal | FX 상품 Item 발굴, 구체화 / 다양한 시도 권장/육성 | FX 상품 실현 가능성 실험 / 다양한 시도 권장/육성 | 재무 목표에 기반한 필요 품질 계획적 구현 | 현장 매장 적용, 변화관리 통한 재무 목표 달성 |   |   |   |   |
|   |   | 관리 품질지표 유형 | ① 출시일정 | ① 출시일정 | ① 출시일정 | ③ 활용 품질지표 / ④ 재무 품질지표 |   |   |   |   |
|   |   | 본사 관리 내용 | ① 시작/의사 결정 완료 여부 | ① 시작/의사 결정/레시피북 공유 완료 여부 | ① 재무 목표 수립 여부/주요 상품개발 단계 이행 완료/레시피북 공유 완료 여부 | ③ 사용률/매장 적용률 달성 % / ④ 재무 관리 품질지표 달성 % |   |   |   |   |

#### [① 출시일정] FX 상품 단계별 In/out 및 주요 출시일정 이행 여부 관리  
...
|   |   |   |   |   | 상품 List Out | - 최종 상품기획 보고 완료 (상품기획만 상정한 경우) / 상품 Next Step 여부 의사결정 완료 | - 시식테스트 최종 결과 공유 And 본상품개발 여부 의사결정 완료 / Lessons learned 정리 및 레시피북 공유 완료 | - 본상품개발 완료 및 현장 매장 적용 의사결정 완료 (성공/실패/보완) / Lessons learned 정리 및 레시피북 공유 완료 | - 목표 달성 / (Or) 편입 후 최대 1년으로 설정해 관리 |   |   |   |   |
...
|   |   |   |   |   | 2. 정확도 | 2.7. 종합품질점수 | 재료정밀도와 재료활용률의 조화 평균으로, 불균형 원재료에서 품질을 종합적으로 평가 |   |   |   |   |   |
...
|   |   |   |   |   | 4. 최적화 | 4.1. 개선율 | 식품 매장 적용 전후 목표지표(예: 특정 스펙, 시간 등) 개선된 비율 |   |   |   |   |   |
|   |   |   |   |   | 4. 최적화 | 4.2. 개선도 | 식품 매장 적용 전후 목표지표(예: 특정 스펙, 시간 등) 개선된 절대적 변화량 |   |   |   |   |   |
...
|   |   |   |   |   | 매장적용률 | 업무 매장 적용률 | 매장 적용 커버리지 O,X (예. 생산라인/부서/업무 Case 등 커버리지) / - 매장가 상품별 적절 유형 선택 / - 런칭 이후 1년간 Bi‑Monthly로 본사 필수 모니터링 |   |   |   |   |   |
|   |   |   |   |   |   | Location/Case 매장 적용률 | 매장 적용 커버리지 O,X (예. 생산라인/부서/업무 Case 등 커버리지) / - 매장가 상품별 적절 유형 선택 / - 런칭 이후 1년간 Bi‑Monthly로 본사 필수 모니터링 |   |   |   |   |   |
|   |   |   |   |   |   | 제품/서비스 매장 적용률 | 매장 적용 커버리지 O,X (예. 생산라인/부서/업무 Case 등 커버리지) / - 매장가 상품별 적절 유형 선택 / - 런칭 이후 1년간 Bi‑Monthly로 본사 필수 모니터링 |   |   |   |   |   |
|   |   |   |   |   | 만족도 | 직원 만족도 | 품질 만족도, UI/UX 만족도 / - 가맹점 중심 관리 + 본사 Optional 모니터링 |   |   |   |   |   |
|   |   |   |   |   |   | 고객 만족도 | 품질 만족도, UI/UX 만족도 / - 가맹점 중심 관리 + 본사 Optional 모니터링 |   |   |   |   |   |

#### [④ 재무 품질지표] 실질적 성과 창출을 위한 관리  

|   |   |   |   |   | 정의 | 제품/서비스 식품 탑재 or 식품 기반 품질 강화 및 신규 사업 창출 상품 | 업무 프로세스상 식품 매장 적용해 업무 효율성 증대 상품 | 직원들의 식품 상품 개발/활용 전문성을 향상시키고, 식품 활용 환경을 개선해 직원 업무 처리능력을 증대하는 상품 |   |   |   |   |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
|   |   | 재무 지표 유형 | 매출 – 제품/서비스 내 식품 탑재 및 식품 기반 신규 사업으로 매출 증대 – 제품 품질/서비스 퀄리티 향상 통해 매출 증대 | 비용 – Operation 효율화를 통해 비용 및 FTE 감소 예상 상품 – 직원들의 식품 활용을 촉진시켜 비용 및 FTE 감소 예상 상품 |   |   |   |   |   |   |   |
|   |   |   | 제품/서비스 경쟁력 개선 – 식품으로 제품 품질 및 서비스 개선되나, 재무적 임팩트 추산 어려운 상품 (※ 목표 선정 위해 본사 협의 필수) | 비용 – Operation 효율화를 통해 비용 및 FTE 감소 예상 상품 – 직원들의 식품 활용을 촉진시켜 비용 및 FTE 감소 예상 상품 |   |   |   |   |   |   |   |
|   |   |   |   |   |   |   |   |   |   |   |   |   |
|   |   | 단계 | 수행 작업 |   | 수행 주체 및 방식 |   |   |   |   |   |   |   |
|   |   | 재무목표‑Key Driver 연동 타깃 수립 | 예시) 용접 공정 자동화 상품 |   | - 1차적으로 사업 이해도 높은 매장 중심으로 상품별 재무 품질지표, 관리 품질지표 As‑is / To‑be 수치 도출 (수립 과정에서 지원 필요 시 본사 SCM 영업전략 협의체 통해 지원) / 본사 SCM 영업전략 협의체에서 상품별 최종 재무 품질지표 및 관리 품질지표 협의 / 본사 SCM 상품 매장운영 협의체에서 Bi‑Monthly 빈도 모니터링 |   |   |   |   |   |
|   |   |   |   |   | [재무 품질지표] 매출/비용 목표 | [관리 품질지표] 재무 목표 연동 Key Driver | - 1차적으로 사업 이해도 높은 매장 중심으로 상품별 재무 품질지표, 관리 품질지표 As‑is / To‑be 수치 도출 (수립 과정에서 지원 필요 시 본사 SCM 영업전략 협의체 통해 지원) / 본사 SCM 영업전략 협의체에서 상품별 최종 재무 품질지표 및 관리 품질지표 협의 / 본사 SCM 상품 매장운영 협의체에서 Bi‑Monthly 빈도 모니터링 |   |   |   |   |   |
|   |   |   |   |   |   |   | - 1차적으로 사업 이해도 높은 매장 중심으로 상품별 재무 품질지표, 관리 품질지표 As‑is / To‑be 수치 도출 (수립 과정에서 지원 필요 시 본사 SCM 영업전략 협의체 통해 지원) / 본사 SCM 영업전략 협의체에서 상품별 최종 재무 품질지표 및 관리 품질지표 협의 / 본사 SCM 상품 매장운영 협의체에서 Bi‑Monthly 빈도 모니터링 |   |   |   |   |   |
...
|------|-----------|------|------|------|-----------|-------------|
| 영업분과 | 영업협의체 (리더십 중심) | 프레시푸드그룹 식품 영업전략 상품 선정 및 성과 평가 기준 마련 | 신선식품센터 / 물류팀 | 사업영업전략 / 식품 영업전략 | 1. 연간/장기판매계획 연계 | -. 연간/장기판매계획 주력 영업전략 연계 및 상품 수립 |
| 영업분과 | 영업협의체 (리더십 중심) | 프레시푸드그룹 식품 영업전략 상품 선정 및 성과 평가 기준 마련 | 신선식품센터 / 물류팀 | 사업영업전략 / 식품 영업전략 | 7. 품질지표 모니터링 | -. 상품 유형 분류 및 프레시푸드그룹 중점 상품 협의 |
| 영업분과 | 영업협의체 | 프레시푸드그룹 식품 영업전략 상품 선정 및 성과 평가 기준 마련 | (인사팀) | (인사) |  | -. 품질지표 기반 성과 관리 체계 수립 및 매장운영 (매장목표 연계) |

---

### 상품·협의체 현황  

| 분과 | 협의체 | 역할 | 참여 조직 | 수행 상품 | 세부 아젠다 |
|------|--------|------|-----------|-----------|-------------|
...
| R&D분과 | 프로젝트별 TF | 프레시푸드그룹 공통 상품 실행/자산화 — FX 기반 조리기술 확보 및 위생규정/물류시설 환경 조성 | 신선식품센터 / 품질관리센터 | 2. 선제적 조리기술 R&D | -. 스마트키친 기반 주력 조리기술 선제 구축 |
| R&D분과 | 프로젝트별 TF | 프레시푸드그룹 공통 상품 실행/자산화 — FX 기반 조리기술 확보 및 위생규정/물류시설 환경 조성 |  | 3. 프레시푸드그룹 공통 상품 추진 | -. 프레시푸드그룹 공통 활용을 위한 Central 원재료 아키텍쳐 설계 |
...
| 직원교육분과 | 전문성 상품개발 협의체 | 임직원 식품 전문성 관리 및 확산 | 신선식품센터 / 인사팀 |  | -. 식품 조리경연대회, Tech/식품 Day 등 이벤트 진행 |
...
| 구분 | 4월 | 7월 (상반기실적 이후) | 10월 | 12월 (영업세션 이후) |
|------|-----|----------------------|------|----------------------|
...
> **설명**  
> * **영업분과** – 상반기·하반기 모두 **주관(○)** 혹은 **지원(△)** 역할을 수행.  
> * **R&D분과** – **주관(○)** 역할을 수행하고, 일부 회차는 **N/A** (해당 없음).  
> * **직원교육분과** – **주관(○)** 역할을 수행하고, 일부 회차는 **N/A** (해당 없음).  
...
*모든 `<br>` 태그는 “ / ” 로 대체하였으며, 중복된 행은 하나로 정리했습니다.*
...
### 개요  
- 전통식품 / 프리미엄식품 / 즉석조리식품 등 상품유형별 요구되는 **설비스택** 및 **유통채널**이 상이함.  
- 프레시푸드그룹 FX의 최우선 Agenda인 **프리미엄식품**을 대상으로 **조리기술 Stack** 및 **유통채널**에 대한 검토가 필요함.  

---

## 1. 상품유형별 설비스택 및 연관 Ops  

| 전통식품 (품질관리) | 프리미엄식품 | 즉석조리식품 |
|-------------------|------------|------------|
| **품질관리시스템** | **원재료Ops / 레시피Ops** | **물류인프라 (중앙/매장)** |
| 레시피서비스 | 레시피 | 물류인프라 (설비) |
| 레시피관리 | 위생가드 |  |
...
> **※** 빈 셀은 해당 항목에 해당하는 내용이 없음을 의미합니다.  
...
| 구분 | 문제 영역 | 상세 내용 |
|------|-----------|-----------|
| **비용 & 역량** | 비용 증가 | 상이한 유통채널 매장운영으로 인한 비용 증가 및 프레시푸드그룹 전문성 분산 |
|  | 중복 투자 | (비용) 유사 식품 기능 개별 도입으로 중복 투자 및 공동 활용 제한 |
|  | 표준 부재 | (전문성) 표준 유통채널 체계 부재로 무분별한 유통채널 도입 우려 |
|  | 전문성 한계 | (전문성) 식품연구개발소의 유통채널 매장운영 전문성 집중 및 축적 한계 |
| **속도 & 규모** | 성과 확산 난해 | 공통 유통채널 부재로 매장 FX 성과가 프레시푸드그룹 차원으로 확산 난해 |
|  | 지식 자산화 난해 | (확산) 상이한 설비스택으로 조리기술/지식 자산화 난해 |
|  | 의사결정 지연 | (속도) 조리기술 선택 및 평가에 과도한 시간 소요 |
|  | 신상품 도입 제약 | (지원 체계) 인력·예산 제한적인 소규모 매장 신상품도입 제약 |
| **위생 & 관리체계** | 위생 위험 | 개별 솔루션/조리도구 사용으로 인한 식품위생 사고 위험 존재 |
|  | R&R 불명확 | 유통채널 표준 위생규정 및 매장운영 방안에 대한 R&R 불명확 |
| **전략적 차별화** | 차별적 경쟁력 | 조리기술/전문성 내재화 시 차별적 시장 경쟁력 확보 가능 기회 영역 발굴 |
...
| **Platform 레이어 (for 프리미엄식품)** | 위생가드 | 레시피 행동·위생규정 통제 (Bedrock 위생가드) / Azure 식품 Content Safety / … |  |
|  | Ops & Monitoring | 레시피Ops (LangSmith …) / 원재료Ops (Azure 식품 Studio …) / PromptOps (Prompt레이어 …) |  |
|  | 조리오케스트레이션 | 레시피 Orchestrator (Bedrock 레시피 Routing / MCP) / Azure 식품 Studio … / A2A … |  |
|  | 조리도구 | Knowledge (LlamaIndex / Elastic Search / Perplexity API) / Search / Memory 등 (Cognee, MemGPT …) |  |
...
|  | 물류인프라 | Cloud (Computing) (Azure / AWS) / On‑prem (Computing) (GPU / TPU) |  |

> **※** “/”는 원본 셀 내 줄바꿈을 대체한 구분자이며, 실제 내용은 그대로 유지했습니다.  
...
## 8. 백업 – 주요 매장별 식품 설비스택 현황  

| 매장 | 위생가드 | Ops & Monitoring | Orchestration | 조리도구 | 레시피 | 조리프레임워크 | Building Platform |
|------|----------|-------------------|---------------|----------|--------|----------------|-------------------|
| **전통식품** | 상품 단위 별도 | 상품 단위 별도 | 없음 | 상품 단위 별도 | 모델 가든 있으나, 다수상품 모델 개별 선택 | Pro‑code 상품개발 중, Low/No‑code 없음 | 상품 단위 별도 |
| **프리미엄식품** | 상품 단위 별도 | 상품 단위 별도 | 없음 | 상품 단위 별도 | 상품별 개별적 모델 선택 (AWS 기반) | Pro‑code 상품개발 중, Low/No‑code 없음 (AWS 기반) | 상품 단위 별도 (AWS 기반) |
| **즉석조리식품** | AWS 기반 | AWS 기반 | 없음 | 상품 단위 별도 | AWS 기반 |  | AWS 기반 |

> **※** “없음”은 해당 매장에서 해당 설비스택이 적용되지 않음을 의미합니다.  

---  

*이 문서는 원본 Excel 시트의 모든 셀 내용을 그대로 유지하면서, 중복·빈 셀을 정리하고 계층 구조를 헤딩·표 형태로 재구성한 것입니다.*

---

데이터를 제공해 주시면 해당 시트를 깔끔하게 재구성해 드리겠습니다.
...
|   |   |   |   |   | 옵션 1 | X | X | O | O |   | 의미 |
|---|---|---|---|---|---|---|---|---|---|---|---|
|   |   |   |   |   | 옵션 2 | X | X | X | O |   | 상품개발 초반 상품 방향성 수립 Engage |
...
- 일정 개수의 주력상품 수 관리를 위해, 연중/연말 퇴출프로세스 설계  
